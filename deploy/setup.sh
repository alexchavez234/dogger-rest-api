...
PROJECT_GIT_URL='https://github.com/alexchavez234/dogger-rest-api.git'
...
cp $PROJECT_BASE_PATH/deploy/supervisor_profiles_api.conf /etc/supervisor/conf.d/dogger_api.conf
